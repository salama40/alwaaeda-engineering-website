...
const siteUrl = 'https://www.alwaeda-engineering.com' // استبدل بـ دومين موقعك الحقيقي
...
export const buildEnd = async (config: SiteConfig): Promise<void> => {
  const feed = new Feed({
    ...
    image: `${siteUrl}/assets/alwaeda-og-image.jpg`, // رابط صورة كبيرة معبرة للمدونة
    favicon: `${siteUrl}/favicon.ico`, // رابط أيقونة موقعك
    copyright: 'حقوق النشر © 2023-present شركةالهندسية الواعدة للمصاعد. جميع الحقوق محفوظة.', // حقوق النشر لشركتك (تم تعديلها للغة العربية)
  })
